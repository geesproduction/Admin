...
implements Cloneable {
    ...
    public ZioEntry(String string2) {
    ...
    public ZioEntry(String string2, String string3) throws IOException {
        this.numAlignBytes = 0;
        this.dataPosition = -1L;
        this.data = null;
        this.entryOut = null;
        this.zipInput = new ZipInput(string3);
        this.filename = string2;
        this.fileComment = "";
        this.compression = 0;
        ...
        if (ZioEntry.getLogger().isDebugEnabled()) {
            ...
            Object[] arrobject = new Object[]{string3, this.size};
        ...
        this.extraData = new byte[0];
        this.setTime(new File(string3).lastModified());
    }

    public ZioEntry(String string2, String string3, short s, int n, int n2, int n3) throws IOException {
        this.numAlignBytes = 0;
        this.dataPosition = -1L;
        this.data = null;
        this.entryOut = null;
    ...
    public static ZioEntry read(ZipInput zipInput) throws IOException {
        if (zipInput.readInt() != 33639248) {
            zipInput.seek(zipInput.getFilePointer() - 4L);
            return null;
        }
    ...
    public ZioEntry getClonedEntry(String string2) {
        ZioEntry zioEntry;
        try {
    ...
    public void readLocalHeader() throws IOException {
        ...
        String string2 = zipInput.readString(s6);
        if (bl) {
            log.debug("Filename: " + string2);
        }
    ...
    public void setTime(long l) {
        ...
        long l2 = n < 1980 ? 2162688L : (long)(n - 1980 << 25 | 1 + date.getMonth() << 21 | date.getDate() << 16 | date.getHours() << 11 | date.getMinutes() << 5 | date.getSeconds() >> 1);
        this.modificationDate = (short)(l2 >> 16);
        this.modificationTime = (short)(65535L & l2);
    }
    ...
    public void writeLocalEntry(ZipOutput zipOutput) throws IOException {
        ...
        zipOutput.writeShort((short)this.filename.length());
        this.numAlignBytes = 0;
        if (this.compression == 0 && (s = (short)((long)(2 + zipOutput.getFilePointer() + this.filename.length() + this.extraData.length) % 4L)) > 0) {
        ...
        if (this.data != null) {
            ...
            int n2 = Math.min((int)this.compressedSize, (int)8096);
            byte[] arrby = new byte[n2];
            for (long i = 0L; i != (long)this.compressedSize; i += (long)n) {
                n = this.zipInput.in.read(arrby, 0, (int)Math.min((long)((long)this.compressedSize - i), (long)n2));
                if (n <= 0) {
                    Object[] arrobject = new Object[]{this.filename, (long)this.compressedSize - i};
                ...
                zipOutput.writeBytes(arrby, 0, n);
                if (!bl) continue;
                LoggerInterface loggerInterface = ZioEntry.getLogger();
                Object[] arrobject = new Object[]{n};
                loggerInterface.debug(String.format((String)"Wrote %d bytes", (Object[])arrobject));
